...
public class Filing_ {
    ...
    private OtherAttributes_ otherAttributes;
    @JsonIgnore
     ...
     */
    @JsonProperty("other_attributes")
    public OtherAttributes_ getOtherAttributes() {
     ...
     */
    @JsonProperty("other_attributes")
    public void setOtherAttributes(OtherAttributes_ otherAttributes) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Filing_) == false) {
            return false;
        }
        Filing_ rhs = ((Filing_) other);
