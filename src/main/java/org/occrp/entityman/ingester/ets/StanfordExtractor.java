...
import org.occrp.entityman.ingester.expanders.AExpander;
...
public class StanfordExtractor extends AExtractor {
	...
	Map<String, EntityCreator> ecMapping = new HashMap<String,EntityCreator>() {{
